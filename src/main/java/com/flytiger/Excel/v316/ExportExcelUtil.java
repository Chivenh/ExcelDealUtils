...
/**
	...
	private enum TAlign {
		...
		private TAlign(HorizontalAlignment ment) {
			this.ment = ment;
		}
	}
	...
	private enum VAlign {
		...
		private VAlign(VerticalAlignment ment) {
			this.ment = ment;
		}
	}
	...
	public class ExpStyle {
		...
		/** 复制一个对象的的可写属性到另一个同类对象 */
		BinaryOperator<Object> trans = (x, y) -> {
		...
		private ExpStyle(HSSFWorkbook work, HSSFCellStyle expStyle) {
			...
			trans.apply(expStyle, this.expStyle);// 调用复制方法.
			this.expFont = work.createFont();
		}
